...
export declare class ListRendererComponentV2 implements OnInit, OnDestroy {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<ListRendererComponentV2, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<ListRendererComponentV2, "app-list-renderer-v2", never, { "sectionData": { "alias": "sectionData"; "required": false; }; "stepId": { "alias": "stepId"; "required": false; }; "templateId": { "alias": "templateId"; "required": false; }; "type": { "alias": "type"; "required": false; }; "rowData": { "alias": "rowData"; "required": false; }; "rootData": { "alias": "rootData"; "required": false; }; "childList": { "alias": "childList"; "required": false; }; }, {}, never, never, true, never>;
}
//# sourceMappingURL=list-renderer-v2.component.d.ts.map