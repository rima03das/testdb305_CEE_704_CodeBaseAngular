...
export declare class TreeRendererComponent implements OnInit, OnDestroy {
    ...
    componentMap: {
        ...
        Textfield: import("rxjs").Observable<any>;
        ...
        Link: import("rxjs").Observable<any>;
        Video: import("rxjs").Observable<any>;
        Table: import("rxjs").Observable<any>;
    ...
    lazyLoading(): void;
    setRecursiveData(displayValues: any): any[];
     ...
     */
    list_change(data: any, isChecked: boolean, context?: any): void;
    /**
    ...
    getExpandedStatus(elementId: any): boolean;
    toggle(elementId: any): void;
    /**
     * unsubscribe all the subscriptions on ngDestroy
     */
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<TreeRendererComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<TreeRendererComponent, "app-tree-renderer", never, { "sectionData": { "alias": "sectionData"; "required": false; }; "stepId": { "alias": "stepId"; "required": false; }; "templateId": { "alias": "templateId"; "required": false; }; "type": { "alias": "type"; "required": false; }; "rowData": { "alias": "rowData"; "required": false; }; "rootData": { "alias": "rootData"; "required": false; }; "childList": { "alias": "childList"; "required": false; }; }, {}, never, never, true, never>;
}
//# sourceMappingURL=tree-renderer.component.d.ts.map